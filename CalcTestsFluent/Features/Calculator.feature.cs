...
namespace CalcTestsFluent.Features
{
...
#line hidden
        ...
        public CalculatorFeature(CalculatorFeature.FixtureData fixtureData, CalcTestsFluent_XUnitAssemblyFixture assemblyFixture, Xunit.Abstractions.ITestOutputHelper testOutputHelper)
        {
        ...
        [Xunit.InlineDataAttribute("12", "Sum", "7", "19", new string[0])]
        [Xunit.InlineDataAttribute("20", "Divide", "0", "", new string[0])]
        [Xunit.InlineDataAttribute("20", "Multiply", "0", "0", new string[0])]
        [Xunit.InlineDataAttribute("20", "Subtract", "10", "10", new string[0])]
        [Xunit.InlineDataAttribute("10", "Divide", "5", "2", new string[0])]
        public virtual void AddTwoNumbers(string first, string operation, string second, string result, string[] exampleTags)
        {
